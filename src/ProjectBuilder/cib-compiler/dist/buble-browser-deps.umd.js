(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.buble = {}));
  ...
  types$1._function.updateContext = types$1._class.updateContext = function(prevType) {
    if (prevType.beforeExpr && prevType !== types$1._else &&
        !(prevType === types$1.semi && this.curContext() !== types$1$1.p_stat) &&
  ...
  Object.defineProperty(module.exports, "tokTypes", {
    get: function get_tokTypes() {
      return getJsxTokens(acorn.exports).tokTypes;
    },
    configurable: true,
    enumerable: true
  });
  ...
  function plugin(options, Parser) {
    var acorn$1 = Parser.acorn || acorn.exports;
    var acornJsx = getJsxTokens(acorn$1);
    var tt = acorn$1.tokTypes;
    var tok = acornJsx.tokTypes;
    var tokContexts = acorn$1.tokContexts;
    var tc_oTag = acornJsx.tokContexts.tc_oTag;
    var tc_cTag = acornJsx.tokContexts.tc_cTag;
    var tc_expr = acornJsx.tokContexts.tc_expr;
    var isNewLine = acorn$1.isNewLine;
    var isIdentifierStart = acorn$1.isIdentifierStart;
    var isIdentifierChar = acorn$1.isIdentifierChar;
  ...
  var acornJsx = acornJsx$1.exports;
