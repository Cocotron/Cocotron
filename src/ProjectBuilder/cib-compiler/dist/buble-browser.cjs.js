...
var acornJsx__default = /*#__PURE__*/_interopDefaultLegacy(acornJsx);
...
function Program(source, ast, transforms, options) {
	...
	this.source = source;
	this.magicString = new MagicString__default['default'](source);
...
var parser = acorn.Parser.extend(acornJsx__default['default']());
